...
|---|---|---|---|---|
| 01 | [Encoded PowerShell Command Execution](rules/proc_creation_win_powershell_encoded_command.yml) | T1059.001, T1027 | `test` | [Field Selection](writeups/field-selection.md) |
